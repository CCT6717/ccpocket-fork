...
/// Theme mode: system, light, or dark.
 ThemeMode get themeMode;/// Selected accent palette for light and dark themes.
 ThemePalette get themePalette;/// App display locale ID (e.g. 'ja', 'en').
...
/// Empty string means use device default.
 ...
 double get textScale;/// Font size used only for code-oriented surfaces.
 double get codeFontSize;/// Font family used only for code-oriented surfaces.
 CodeFontFamily get codeFontFamily;/// Whether to hide the voice input button in the chat input bar.
 bool get hideVoiceInput;/// Shortcut used to attach images from the clipboard on macOS.
 ImagePasteShortcut get imagePasteShortcut;/// How the Git diff screen maps horizontal gestures to actions.
...
@useResult
$Res call({
 ThemeMode themeMode, ThemePalette themePalette, String appLocaleId, String speechLocaleId, Set<String> fcmEnabledMachines, Set<String> fcmPrivacyMachines, String? activeMachineId, bool fcmAvailable, bool fcmSyncInProgress, FcmStatusKey? fcmStatusKey, String shorebirdTrack, int indentSize, double textScale, double codeFontSize, CodeFontFamily codeFontFamily, bool hideVoiceInput, ImagePasteShortcut imagePasteShortcut, GitDiffInteractionMode gitDiffInteractionMode, bool gitDiffFocusAutoLandscape, bool showRemoteGitStatusBadge, bool showBridgeNameInSessionList, AppIconVariant selectedAppIcon, bool appIconSupported, TerminalAppConfig terminalApp, List<NewSessionTab> newSessionTabs, UsageDisplayMode usageDisplayMode, bool autoRenameCodexSessions, bool autoRenameClaudeSessions
});
...
as double,codeFontSize: null == codeFontSize ? _self.codeFontSize : codeFontSize // ignore: cast_nullable_to_non_nullable
as double,codeFontFamily: null == codeFontFamily ? _self.codeFontFamily : codeFontFamily // ignore: cast_nullable_to_non_nullable
as CodeFontFamily,hideVoiceInput: null == hideVoiceInput ? _self.hideVoiceInput : hideVoiceInput // ignore: cast_nullable_to_non_nullable
as bool,imagePasteShortcut: null == imagePasteShortcut ? _self.imagePasteShortcut : imagePasteShortcut // ignore: cast_nullable_to_non_nullable
as ImagePasteShortcut,gitDiffInteractionMode: null == gitDiffInteractionMode ? _self.gitDiffInteractionMode : gitDiffInteractionMode // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode themeMode,  ThemePalette themePalette,  String appLocaleId,  String speechLocaleId,  Set<String> fcmEnabledMachines,  Set<String> fcmPrivacyMachines,  String? activeMachineId,  bool fcmAvailable,  bool fcmSyncInProgress,  FcmStatusKey? fcmStatusKey,  String shorebirdTrack,  int indentSize,  double textScale,  double codeFontSize,  CodeFontFamily codeFontFamily,  bool hideVoiceInput,  ImagePasteShortcut imagePasteShortcut,  GitDiffInteractionMode gitDiffInteractionMode,  bool gitDiffFocusAutoLandscape,  bool showRemoteGitStatusBadge,  bool showBridgeNameInSessionList,  AppIconVariant selectedAppIcon,  bool appIconSupported,  TerminalAppConfig terminalApp,  List<NewSessionTab> newSessionTabs,  UsageDisplayMode usageDisplayMode,  bool autoRenameCodexSessions,  bool autoRenameClaudeSessions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsState() when $default != null:
return $default(_that.themeMode,_that.themePalette,_that.appLocaleId,_that.speechLocaleId,_that.fcmEnabledMachines,_that.fcmPrivacyMachines,_that.activeMachineId,_that.fcmAvailable,_that.fcmSyncInProgress,_that.fcmStatusKey,_that.shorebirdTrack,_that.indentSize,_that.textScale,_that.codeFontSize,_that.codeFontFamily,_that.hideVoiceInput,_that.imagePasteShortcut,_that.gitDiffInteractionMode,_that.gitDiffFocusAutoLandscape,_that.showRemoteGitStatusBadge,_that.showBridgeNameInSessionList,_that.selectedAppIcon,_that.appIconSupported,_that.terminalApp,_that.newSessionTabs,_that.usageDisplayMode,_that.autoRenameCodexSessions,_that.autoRenameClaudeSessions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode themeMode,  ThemePalette themePalette,  String appLocaleId,  String speechLocaleId,  Set<String> fcmEnabledMachines,  Set<String> fcmPrivacyMachines,  String? activeMachineId,  bool fcmAvailable,  bool fcmSyncInProgress,  FcmStatusKey? fcmStatusKey,  String shorebirdTrack,  int indentSize,  double textScale,  double codeFontSize,  CodeFontFamily codeFontFamily,  bool hideVoiceInput,  ImagePasteShortcut imagePasteShortcut,  GitDiffInteractionMode gitDiffInteractionMode,  bool gitDiffFocusAutoLandscape,  bool showRemoteGitStatusBadge,  bool showBridgeNameInSessionList,  AppIconVariant selectedAppIcon,  bool appIconSupported,  TerminalAppConfig terminalApp,  List<NewSessionTab> newSessionTabs,  UsageDisplayMode usageDisplayMode,  bool autoRenameCodexSessions,  bool autoRenameClaudeSessions)  $default,) {final _that = this;
switch (_that) {
case _SettingsState():
return $default(_that.themeMode,_that.themePalette,_that.appLocaleId,_that.speechLocaleId,_that.fcmEnabledMachines,_that.fcmPrivacyMachines,_that.activeMachineId,_that.fcmAvailable,_that.fcmSyncInProgress,_that.fcmStatusKey,_that.shorebirdTrack,_that.indentSize,_that.textScale,_that.codeFontSize,_that.codeFontFamily,_that.hideVoiceInput,_that.imagePasteShortcut,_that.gitDiffInteractionMode,_that.gitDiffFocusAutoLandscape,_that.showRemoteGitStatusBadge,_that.showBridgeNameInSessionList,_that.selectedAppIcon,_that.appIconSupported,_that.terminalApp,_that.newSessionTabs,_that.usageDisplayMode,_that.autoRenameCodexSessions,_that.autoRenameClaudeSessions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode themeMode,  ThemePalette themePalette,  String appLocaleId,  String speechLocaleId,  Set<String> fcmEnabledMachines,  Set<String> fcmPrivacyMachines,  String? activeMachineId,  bool fcmAvailable,  bool fcmSyncInProgress,  FcmStatusKey? fcmStatusKey,  String shorebirdTrack,  int indentSize,  double textScale,  double codeFontSize,  CodeFontFamily codeFontFamily,  bool hideVoiceInput,  ImagePasteShortcut imagePasteShortcut,  GitDiffInteractionMode gitDiffInteractionMode,  bool gitDiffFocusAutoLandscape,  bool showRemoteGitStatusBadge,  bool showBridgeNameInSessionList,  AppIconVariant selectedAppIcon,  bool appIconSupported,  TerminalAppConfig terminalApp,  List<NewSessionTab> newSessionTabs,  UsageDisplayMode usageDisplayMode,  bool autoRenameCodexSessions,  bool autoRenameClaudeSessions)?  $default,) {final _that = this;
switch (_that) {
case _SettingsState() when $default != null:
return $default(_that.themeMode,_that.themePalette,_that.appLocaleId,_that.speechLocaleId,_that.fcmEnabledMachines,_that.fcmPrivacyMachines,_that.activeMachineId,_that.fcmAvailable,_that.fcmSyncInProgress,_that.fcmStatusKey,_that.shorebirdTrack,_that.indentSize,_that.textScale,_that.codeFontSize,_that.codeFontFamily,_that.hideVoiceInput,_that.imagePasteShortcut,_that.gitDiffInteractionMode,_that.gitDiffFocusAutoLandscape,_that.showRemoteGitStatusBadge,_that.showBridgeNameInSessionList,_that.selectedAppIcon,_that.appIconSupported,_that.terminalApp,_that.newSessionTabs,_that.usageDisplayMode,_that.autoRenameCodexSessions,_that.autoRenameClaudeSessions);case _:
  return null;
...
class _SettingsState extends SettingsState {
  const _SettingsState({this.themeMode = ThemeMode.system, this.themePalette = ThemePalette.graphiteEmber, this.appLocaleId = '', this.speechLocaleId = '', final  Set<String> fcmEnabledMachines = const {}, final  Set<String> fcmPrivacyMachines = const {}, this.activeMachineId, this.fcmAvailable = false, this.fcmSyncInProgress = false, this.fcmStatusKey, this.shorebirdTrack = 'stable', this.indentSize = 2, this.textScale = 1.0, this.codeFontSize = 12.0, this.codeFontFamily = CodeFontFamily.jetBrainsMono, this.hideVoiceInput = false, this.imagePasteShortcut = ImagePasteShortcut.ctrlV, this.gitDiffInteractionMode = GitDiffInteractionMode.quickActions, this.gitDiffFocusAutoLandscape = false, this.showRemoteGitStatusBadge = false, this.showBridgeNameInSessionList = true, this.selectedAppIcon = AppIconVariant.defaultIcon, this.appIconSupported = false, this.terminalApp = TerminalAppConfig.empty, final  List<NewSessionTab> newSessionTabs = defaultNewSessionTabs, this.usageDisplayMode = UsageDisplayMode.remaining, this.autoRenameCodexSessions = true, this.autoRenameClaudeSessions = false}): _fcmEnabledMachines = fcmEnabledMachines,_fcmPrivacyMachines = fcmPrivacyMachines,_newSessionTabs = newSessionTabs,super._();
  

/// Theme mode: system, light, or dark.
@override@JsonKey() final  ThemeMode themeMode;
/// Selected accent palette for light and dark themes.
@override@JsonKey() final  ThemePalette themePalette;
...
@override@JsonKey() final  CodeFontFamily codeFontFamily;
...
@override@JsonKey() final  ImagePasteShortcut imagePasteShortcut;
...
@override
int get hashCode => Object.hashAll([runtimeType,themeMode,themePalette,appLocaleId,speechLocaleId,const DeepCollectionEquality().hash(_fcmEnabledMachines),const DeepCollectionEquality().hash(_fcmPrivacyMachines),activeMachineId,fcmAvailable,fcmSyncInProgress,fcmStatusKey,shorebirdTrack,indentSize,textScale,codeFontSize,codeFontFamily,hideVoiceInput,imagePasteShortcut,gitDiffInteractionMode,gitDiffFocusAutoLandscape,showRemoteGitStatusBadge,showBridgeNameInSessionList,selectedAppIcon,appIconSupported,terminalApp,const DeepCollectionEquality().hash(_newSessionTabs),usageDisplayMode,autoRenameCodexSessions,autoRenameClaudeSessions]);
...
/// Create a copy of SettingsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? themeMode = null,Object? themePalette = null,Object? appLocaleId = null,Object? speechLocaleId = null,Object? fcmEnabledMachines = null,Object? fcmPrivacyMachines = null,Object? activeMachineId = freezed,Object? fcmAvailable = null,Object? fcmSyncInProgress = null,Object? fcmStatusKey = freezed,Object? shorebirdTrack = null,Object? indentSize = null,Object? textScale = null,Object? codeFontSize = null,Object? codeFontFamily = null,Object? hideVoiceInput = null,Object? imagePasteShortcut = null,Object? gitDiffInteractionMode = null,Object? gitDiffFocusAutoLandscape = null,Object? showRemoteGitStatusBadge = null,Object? showBridgeNameInSessionList = null,Object? selectedAppIcon = null,Object? appIconSupported = null,Object? terminalApp = null,Object? newSessionTabs = null,Object? usageDisplayMode = null,Object? autoRenameCodexSessions = null,Object? autoRenameClaudeSessions = null,}) {
