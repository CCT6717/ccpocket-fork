...
// based on provider (Claude=off, Codex=on).
 ...
 double get totalCost; Duration? get totalDuration;// Monotonic counter: incremented whenever entries list identity changes.
// Used by ChatMessageList to avoid O(n) list comparison in context.select.
 int get entriesVersion;// Slash commands available in this session
 List<SlashCommand> get slashCommands;// Codex conversation queue (Bridge is the source of truth).
 QueuedInputItem? get queuedInput;
...
as ReasoningEffort?,planMode: null == planMode ? _self.planMode : planMode // ignore: cast_nullable_to_non_nullable
...
as Duration?,entriesVersion: null == entriesVersion ? _self.entriesVersion : entriesVersion // ignore: cast_nullable_to_non_nullable
as int,slashCommands: null == slashCommands ? _self.slashCommands : slashCommands // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ProcessStatus status,  List<ChatEntry> entries,  ApprovalState approval,  String? claudeSessionId,  String? projectPath,  String? gitBranch,  String explorerCurrentPath,  List<String> recentPeekedFiles,  bool pastHistoryLoaded,  bool bulkLoading,  bool inPlanMode,  bool collapseToolResults,  PermissionMode permissionMode,  ExecutionMode executionMode,  CodexApprovalPolicy codexApprovalPolicy,  String codexApprovalsReviewer,  CodexPermissionsMode codexPermissionsMode,  String? codexModel,  ReasoningEffort? codexModelReasoningEffort,  bool planMode,  SandboxMode sandboxMode,  Set<String> hiddenToolUseIds,  RewindPreviewMessage? rewindPreview,  double totalCost,  Duration? totalDuration,  int entriesVersion,  List<SlashCommand> slashCommands,  QueuedInputItem? queuedInput)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatSessionState() when $default != null:
return $default(_that.status,_that.entries,_that.approval,_that.claudeSessionId,_that.projectPath,_that.gitBranch,_that.explorerCurrentPath,_that.recentPeekedFiles,_that.pastHistoryLoaded,_that.bulkLoading,_that.inPlanMode,_that.collapseToolResults,_that.permissionMode,_that.executionMode,_that.codexApprovalPolicy,_that.codexApprovalsReviewer,_that.codexPermissionsMode,_that.codexModel,_that.codexModelReasoningEffort,_that.planMode,_that.sandboxMode,_that.hiddenToolUseIds,_that.rewindPreview,_that.totalCost,_that.totalDuration,_that.entriesVersion,_that.slashCommands,_that.queuedInput);case _:
  return orElse();
...
// Used by ChatMessageList to avoid O(n) list comparison in context.select.
@override@JsonKey() final  int entriesVersion;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChatSessionState&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._entries, _entries)&&(identical(other.approval, approval) || other.approval == approval)&&(identical(other.claudeSessionId, claudeSessionId) || other.claudeSessionId == claudeSessionId)&&(identical(other.projectPath, projectPath) || other.projectPath == projectPath)&&(identical(other.gitBranch, gitBranch) || other.gitBranch == gitBranch)&&(identical(other.explorerCurrentPath, explorerCurrentPath) || other.explorerCurrentPath == explorerCurrentPath)&&const DeepCollectionEquality().equals(other._recentPeekedFiles, _recentPeekedFiles)&&(identical(other.pastHistoryLoaded, pastHistoryLoaded) || other.pastHistoryLoaded == pastHistoryLoaded)&&(identical(other.bulkLoading, bulkLoading) || other.bulkLoading == bulkLoading)&&(identical(other.inPlanMode, inPlanMode) || other.inPlanMode == inPlanMode)&&(identical(other.collapseToolResults, collapseToolResults) || other.collapseToolResults == collapseToolResults)&&(identical(other.permissionMode, permissionMode) || other.permissionMode == permissionMode)&&(identical(other.executionMode, executionMode) || other.executionMode == executionMode)&&(identical(other.codexApprovalPolicy, codexApprovalPolicy) || other.codexApprovalPolicy == codexApprovalPolicy)&&(identical(other.codexApprovalsReviewer, codexApprovalsReviewer) || other.codexApprovalsReviewer == codexApprovalsReviewer)&&(identical(other.codexPermissionsMode, codexPermissionsMode) || other.codexPermissionsMode == codexPermissionsMode)&&(identical(other.codexModel, codexModel) || other.codexModel == codexModel)&&(identical(other.codexModelReasoningEffort, codexModelReasoningEffort) || other.codexModelReasoningEffort == codexModelReasoningEffort)&&(identical(other.planMode, planMode) || other.planMode == planMode)&&(identical(other.sandboxMode, sandboxMode) || other.sandboxMode == sandboxMode)&&const DeepCollectionEquality().equals(other._hiddenToolUseIds, _hiddenToolUseIds)&&(identical(other.rewindPreview, rewindPreview) || other.rewindPreview == rewindPreview)&&(identical(other.totalCost, totalCost) || other.totalCost == totalCost)&&(identical(other.totalDuration, totalDuration) || other.totalDuration == totalDuration)&&(identical(other.entriesVersion, entriesVersion) || other.entriesVersion == entriesVersion)&&const DeepCollectionEquality().equals(other._slashCommands, _slashCommands)&&(identical(other.queuedInput, queuedInput) || other.queuedInput == queuedInput));
}


@override
int get hashCode => Object.hashAll([runtimeType,status,const DeepCollectionEquality().hash(_entries),approval,claudeSessionId,projectPath,gitBranch,explorerCurrentPath,const DeepCollectionEquality().hash(_recentPeekedFiles),pastHistoryLoaded,bulkLoading,inPlanMode,collapseToolResults,permissionMode,executionMode,codexApprovalPolicy,codexApprovalsReviewer,codexPermissionsMode,codexModel,codexModelReasoningEffort,planMode,sandboxMode,const DeepCollectionEquality().hash(_hiddenToolUseIds),rewindPreview,totalCost,totalDuration,entriesVersion,const DeepCollectionEquality().hash(_slashCommands),queuedInput]);
...
as double,totalDuration: freezed == totalDuration ? _self.totalDuration : totalDuration // ignore: cast_nullable_to_non_nullable
as Duration?,entriesVersion: null == entriesVersion ? _self.entriesVersion : entriesVersion // ignore: cast_nullable_to_non_nullable
as int,slashCommands: null == slashCommands ? _self._slashCommands : slashCommands // ignore: cast_nullable_to_non_nullable
as List<SlashCommand>,queuedInput: freezed == queuedInput ? _self.queuedInput : queuedInput // ignore: cast_nullable_to_non_nullable
as QueuedInputItem?,
  ));
}
